...
export function findPassenger(passengers, name) {
  // Your code here
    ...
    //return passengers.filter(passenger => passenger.name.toLowerCase() === name.toLowerCase())[0];
...
export function isAnyWaitlisted(passengers) {
  // Your code here
    ...
    //return passengers.filter(passenger => passenger.status === 'waitlisted').length !==0
}
